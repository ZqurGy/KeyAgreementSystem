...
CREATE TABLESPACE ts_seckey_admin 
    LOGGING  
    DATAFILE '/home/zz/app/zz/oradata/orcl/ts_seckeymng_admin.dbf' SIZE 50M 
    EXTENT MANAGEMENT LOCAL;
    

CREATE TABLESPACE ts_seckey_op
    LOGGING 
    DATAFILE '/home/zz/app/zz/oradata/orcl/ts_seckeymng_op.dbf' SIZE 200M
    EXTENT MANAGEMENT LOCAL;
    
ALTER DATABASE DATAFILE '/home/zz/app/zz/oradata/orcl/ts_seckeymng_admin.dbf' AUTOEXTEND ON NEXT   50M MAXSIZE UNLIMITED;
ALTER DATABASE DATAFILE '/home/zz/app/zz/oradata/orcl/ts_seckeymng_op.dbf' AUTOEXTEND ON NEXT  200M MAXSIZE UNLIMITED; 
...
INSERT INTO SECMNG.secnode VALUES('0001', '网银中心', '北京金融街23号', to_date('2023-08-16 21:10:21', 'yyyy-mm-dd hh24:mi:ss'), 1, 0);
INSERT INTO SECMNG.secnode VALUES('1111', '广东分中心1111', '广州天河金融', to_date('2023-08-16 21:10:21', 'yyyy-mm-dd hh24:mi:ss'), 2, 0);
INSERT INTO SECMNG.secnode VALUES('0000', '网银中心', '北京金融街23号', to_date('2023-08-16 21:10:21', 'yyyy-mm-dd hh24:mi:ss'), 3, 0);
INSERT INTO SECMNG.secnode VALUES('2222', '广东分中心1111', '广州天河金融', to_date('2023-08-17 21:10:21', 'yyyy-mm-dd hh24:mi:ss'), 4, 0);
commit;
...
INSERT INTO SECMNG.TRAN(tran_operator, trantime, tranid, trandesc) VALUES(1, to_date('2023-08-16 21:10:21', 'yyyy-mm-dd hh24:mi:ss'), 1, '创建网银总节点-测试数据');
